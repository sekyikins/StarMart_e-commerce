        ...
        <div className="grid md:grid-cols-2 gap-10">
          <div className="space-y-12">
            ...
            <section className="space-y-4">
               ...
               <p className="text-muted-foreground leading-relaxed">
                  By using {storeName}, you agree to provide accurate information regarding your identity and delivery location. We reserve the right to suspend accounts that engage in suspicious or fraudulent activities.
               </p>
            </section>
          </div>
